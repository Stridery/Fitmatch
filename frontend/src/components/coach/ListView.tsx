  ...
  return (
    <div className="flex-1 overflow-auto bg-gray-900 p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Events List */}
        {weekEvents.length > 0 ? (
          <Card className="rounded-2xl shadow-sm border-gray-700 bg-gray-800">
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                {weekEvents.map((event) => (
                  <div
                    key={event.id}
                    className="flex items-center justify-between p-4 bg-gray-700 rounded-lg border border-gray-600 cursor-pointer hover:bg-gray-600 transition-colors"
